...
function git_status {
#    [[ $(git status 2> /dev/null | tail -n1) != "нечего коммитить, нет изменений в рабочем каталоге" ]] && tput setaf 1 || tput setaf 3
    [[ $(git status 2> /dev/null | tail -n1) != "nothing to commit, working tree clean" ]] && tput setaf 1 || tput setaf 3
	 }
	 # tput +
	 # sgr 0 = default color;
